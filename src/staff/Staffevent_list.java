...
public class Staffevent_list extends javax.swing.JFrame {

    public Staffevent_list() {
        initComponents();
        eventList();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staffevent_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Staffevent_list().setVisible(true);
            }
        });
    }
