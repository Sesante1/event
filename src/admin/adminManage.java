...
public class adminManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        events.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                eventsKeyReleased(evt);
            }
        });
        jPanel1.add(events);
        events.setBounds(260, 80, 330, 30);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        adminAdd_Event addEvent = new adminAdd_Event();
        addEvent.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_addButtonActionPerformed

    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        adminEdit_Event editEvent = new adminEdit_Event();
    ...
    private void eventsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_eventsKeyReleased
        
    }//GEN-LAST:event_eventsKeyReleased

    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try{
            DBconnector dbc = new DBconnector();
            ResultSet rs = dbc.getData("SELECT * FROM event_list WHERE Event_Name = '"+ events.getText() +"'");
            eventList.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
        }catch(SQLException ex){
            System.out.println("Errors: "+ex.getMessage());
