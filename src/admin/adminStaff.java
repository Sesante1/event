...
public class adminStaff extends javax.swing.JFrame {
    ...
    public void staffList(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM staff_table WHERE status = '"+ staffStatus.getSelectedItem() +"'");
    ...
    private void initComponents() {
        ...
        participanstButton = new javax.swing.JPanel();
        ...
        staffStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active ", "Pending" }));
        staffStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                staffStatusActionPerformed(evt);
            }
        });
        jPanel1.add(staffStatus);
        staffStatus.setBounds(630, 80, 360, 30);
        jPanel1.add(searchBar);
        searchBar.setBounds(260, 80, 330, 30);
        ...
        viewStaffButton.setBackground(new java.awt.Color(255, 255, 255));
        ...
        viewBookingButton.setBackground(new java.awt.Color(179, 203, 181));
        ...
        viewBookingButtonLayout.setHorizontalGroup(
            ...
            .addGroup(viewBookingButtonLayout.createSequentialGroup()
                .addGap(37, 37, 37)
        ...
        participanstButton.setBackground(new java.awt.Color(179, 203, 181));
        ...
        javax.swing.GroupLayout participanstButtonLayout = new javax.swing.GroupLayout(participanstButton);
        participanstButton.setLayout(participanstButtonLayout);
        participanstButtonLayout.setHorizontalGroup(
            participanstButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(participanstButtonLayout.createSequentialGroup()
                .addGap(27, 27, 27)
                .addComponent(jLabel14)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        participanstButtonLayout.setVerticalGroup(
            participanstButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(participanstButtonLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel14)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(viewBookingButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(39, 39, 39))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addComponent(participanstButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(participanstButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
       adminAdd_Staff addStaff = new adminAdd_Staff();
       addStaff.setVisible(true);
       this.dispose();
    }//GEN-LAST:event_addButtonActionPerformed

    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
       adminEdit_Staff editStaff = new adminEdit_Staff();
       int rowIndex = staffTable.getSelectedRow();
        ...
        if (rowIndex < 0){
            ...
            try {
                DBconnector dbc = new DBconnector();
                TableModel tbl = staffTable.getModel();
                ...
                if (rs.next()){            
                    ...
                    editStaff.gender.setText("" +rs.getString("Sex"));
                    editStaff.contact.setText("" +rs.getString("Contact"));
                    editStaff.age.setText("" +rs.getString("Age"));
                    editStaff.username.setText("" +rs.getString("User_name"));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try{
            DBconnector dbc = new DBconnector();
            ResultSet rs = dbc.getData("SELECT * FROM staff_table WHERE First_Name = '"+ searchBar.getText() +"'");
            staffTable.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
        }catch(SQLException ex){
            System.out.println("Errors: "+ex.getMessage());
    ...
    private javax.swing.JPanel participanstButton;
