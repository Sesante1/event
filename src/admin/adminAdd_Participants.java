...
public class adminAdd_Participants extends javax.swing.JFrame {


    public adminAdd_Participants() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setBounds(80, 260, 160, 30);

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Age:");
        jPanel1.add(jLabel15);
        jLabel15.setBounds(190, 300, 50, 30);

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Gender:");
        jPanel1.add(jLabel16);
        jLabel16.setBounds(170, 340, 70, 30);
        ...
        jPanel1.add(age);
        age.setBounds(270, 300, 190, 30);
        jPanel1.add(gender);
        gender.setBounds(270, 340, 190, 30);
        jPanel1.add(name);
        name.setBounds(270, 260, 190, 30);

        jLabel19.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Event ID:");
        jPanel1.add(jLabel19);
        jLabel19.setBounds(150, 140, 90, 30);
        ...
        jLabel20.setText("Event's Name:");
        jPanel1.add(jLabel20);
        jLabel20.setBounds(120, 180, 120, 30);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        Adminevent_list select = new Adminevent_list();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminAdd_Participants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminAdd_Participants().setVisible(true);
            }
        });
    }
